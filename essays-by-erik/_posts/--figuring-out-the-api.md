...
People are incongruent, myself included. Organizations are made of people.
...
There are all sorts of downsides to focusing on a person's intentions. The [fundamental attribution error](https://en.wikipedia.org/wiki/Fundamental_attribution_error) comes to mind foremost. I'm not saying that trying to understand _why_ someone wants something isn't without value, but 9 times out of 10, it's not necessary to go that deep.
...
I found that every time we discussed a topic in Slack we both reiterated our points, which largely seemed to be in agreement. Eventually I'd say something like, "I think we're in violent agreement." And they'd agree! But neither of us for some reason in those situations felt like we could cut the back-and-forth short and realize early on that we were already on the same page.

It was as if we were speaking sligthly different APIs. In this case, it wasn't even different protocols. Maybe I just wasn't sending the right parameter or our versions were off by a minor number or two.

Articulating this to the EM, they responded "You're right!"

The realization in and of itself wasn't the value here. But being able to internalize it and understand that 